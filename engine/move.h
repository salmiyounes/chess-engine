...
#define EXTRACT_FROM(move) ((int)(((move) >> 0) & 0x3f))

#define EXTRACT_TO(move) ((int)(((move) >> 6) & 0x3f))

#define EXTRACT_FLAGS(move) ((int)(((move) >> 16) & 0xf))

#define EXTRACT_PIECE(move) ((int)(((move) >> 12) & 0xf))
...
int move_estimated_value(ChessBoard *board, Move move);
